...
## Project Structure
    ...
    ├── thats_the_move_movi_34526  # Django project configurations
...
1. Clone this repo and `cd thats_the_move_movi_34526`
...
2. Clone this repo and `cd thats_the_move_movi_34526`
